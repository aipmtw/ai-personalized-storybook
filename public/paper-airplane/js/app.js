/* ============================================
   Book Reader — app.js
   紙飛機環遊世界 / Paper Airplane Around the World
   ============================================ */
...
const pages = [
  {
    ...
    en: '',
    coverTitle: '紙飛機環遊世界',
    coverSubtitle: 'Paper Airplane Around the World',
  ...
  },
  {
    ...
    emoji: '\uD83D\uDC66\u270D\uFE0F\u2708\uFE0F',
    zh: '小智是個愛摺紙飛機的男孩。有一天，他用最喜歡的藍色色紙，摺了一架漂亮的紙飛機，然後在機翼上寫了一個字：「hello」。',
    en: 'Xiao Zhi was a boy who loved folding paper airplanes. One day, he used his favorite blue paper to fold a beautiful airplane, then wrote one word on its wing: "hello."'
  },
  {
    type: 'story',
    bg: 'page-bg-3',
    ...
    emoji: '\uD83C\uDFE0\uD83D\uDCA8\u2708\uFE0F',
    zh: '小智跑到頂樓，用力把紙飛機丟向天空。一陣風吹來，紙飛機越飛越高、越飛越遠，消失在雲層裡。「再見啦，小飛機！」他揮揮手說。',
    en: 'Xiao Zhi ran to the rooftop and threw the paper airplane into the sky with all his might. A gust of wind carried it higher and farther until it disappeared into the clouds. "Goodbye, little airplane!" he waved and said.'
  },
  {
    type: 'story',
    bg: 'page-bg-4',
    ...
    emoji: '\uD83C\uDDEF\uD83C\uDDF5\uD83C\uDF38\uD83D\uDC67',
    zh: '紙飛機飛呀飛，飛過大海，來到了日本。一個穿著和服的小女孩撿到了它，看到上面寫著「hello」，笑了笑，在旁邊加上了「こんにちは」。',
    en: 'The paper airplane flew and flew, crossing the ocean until it reached Japan. A little girl in a kimono picked it up, saw "hello" written on it, smiled, and added "\u3053\u3093\u306B\u3061\u306F" next to it.'
  },
  {
    type: 'story',
    bg: 'page-bg-5',
    ...
    emoji: '\uD83C\uDDEB\uD83C\uDDF7\uD83D\uDDFC\uD83E\uDDD1',
    zh: '紙飛機繼續飛，飛過高山和平原，來到了法國。一個戴貝雷帽的男孩在艾菲爾鐵塔下撿到了它，開心地加上了「bonjour」。',
    en: 'The airplane kept flying, over mountains and plains, until it reached France. A boy wearing a beret found it near the Eiffel Tower and happily added "bonjour."'
  },
  {
    type: 'story',
    bg: 'page-bg-6',
    ...
    emoji: '\uD83C\uDDE7\uD83C\uDDF7\u26BD\uD83D\uDC66\uD83C\uDFFD',
    zh: '紙飛機乘著熱帶的風，來到了巴西。一個正在踢足球的男孩看到紙飛機從天而降，撿起來看了看那些各國的問候語，笑著寫上了「olá」。',
    en: 'Riding tropical winds, the airplane arrived in Brazil. A boy playing soccer saw it fall from the sky, picked it up, read the greetings from around the world, and with a smile wrote "ol\u00E1."'
  },
  {
    type: 'story',
    bg: 'page-bg-7',
    ...
    emoji: '\uD83C\uDDF0\uD83C\uDDEA\uD83E\uDD92\uD83D\uDC69\uD83C\uDFFF',
    zh: '紙飛機又飛過了大西洋，來到了肯亞。一個在草原上放牧的女孩發現了這架寫滿字的紙飛機，她驚訝地讀著每一句問候，然後寫上了「jambo」。',
    en: 'The airplane flew across the Atlantic Ocean to Kenya. A girl herding on the savanna discovered the paper airplane covered in writing, read each greeting with wonder, and added "jambo."'
  },
  {
    type: 'story',
    bg: 'page-bg-8',
    ...
    emoji: '\u2744\uFE0F\uD83C\uDF0D\u2708\uFE0F',
    zh: '紙飛機越飛越遠，飛過了北極上空。冰天雪地裡，北極光閃閃發亮，彷彿在為這架小飛機加油打氣：「加油，快回家吧！」',
    en: 'The airplane flew farther and farther, soaring over the North Pole. In the frozen landscape, the Northern Lights shimmered brightly, as if cheering the little airplane on: "Keep going, fly back home!"'
  },
  {
    type: 'story',
    bg: 'page-bg-9',
    ...
    emoji: '\uD83C\uDDF9\uD83C\uDDFC\uD83D\uDE32\u2708\uFE0F',
    zh: '有一天，小智在陽台上發現了一架紙飛機——是他的紙飛機回來了！上面寫滿了來自世界各地的問候：「hello、こんにちは、bonjour、olá、jambo」。小智簡直不敢相信自己的眼睛。',
    en: 'One day, Xiao Zhi found a paper airplane on his balcony \u2014 his airplane had come back! It was covered with greetings from around the world: "hello, \u3053\u3093\u306B\u3061\u306F, bonjour, ol\u00E1, jambo." Xiao Zhi could hardly believe his eyes.'
  },
  {
    type: 'story',
    bg: 'page-bg-10',
    ...
    emoji: '\u2708\uFE0F\u2708\uFE0F\u2708\uFE0F\uD83D\uDC8C',
    zh: '小智太開心了！他決定摺更多紙飛機，每一架上面都寫著友誼的話語，然後把它們一架一架丟向天空，希望它們能飛到世界的每一個角落。',
    en: 'Xiao Zhi was overjoyed! He decided to fold more paper airplanes, writing messages of friendship on each one, then launching them one by one into the sky, hoping they would reach every corner of the world.'
  },
  {
    type: 'end',
    bg: 'page-bg-12',
    ...
    emoji: '\uD83C\uDF0D\u2764\uFE0F\u2708\uFE0F',
    zh: '小智終於明白了：這個世界雖然很大，但是人與人之間的善意，可以像紙飛機一樣，飛越國界，把每一顆心連在一起。',
    en: 'Xiao Zhi finally understood: although the world is vast, kindness between people can fly across borders like a paper airplane, connecting every heart together.'
  }
];
...
function lineLoginFromGate() {
  ...
  const returnUrl = encodeURIComponent(window.location.origin + '/paper-airplane/book.html');
...
function updateUI() {
  ...
  const colors = ['#29b6f6','#e1f5fe','#fff3e0','#e3f2fd','#fce4ec','#fff8e1','#e8f5e9','#e1f5fe','#f3e5f5','#e8eaf6','#e0f7fa','#e1f5fe'];
  document.querySelector('meta[name="theme-color"]').content = colors[currentPage] || '#29b6f6';
}
...
function toggleAudio() {
  ...
  if (langMode === 'both' || langMode === 'zh') {
    files.push(`/paper-airplane/audio/page-${pageNum}-zh.mp3`);
  }
  if (langMode === 'both' || langMode === 'en') {
    files.push(`/paper-airplane/audio/page-${pageNum}-en.mp3`);
  }
  ...
  for (let i = 0; i < totalDurations.length; i++) {
    ...
    if (cumulative + d >= target) {
      ...
      if (i === currentFileIndex && currentAudio) {
        ...
        const pageNum = currentPage + 1;
        const files = [];
        if (langMode === 'both' || langMode === 'zh') files.push(`/paper-airplane/audio/page-${pageNum}-zh.mp3`);
        if (langMode === 'both' || langMode === 'en') files.push(`/paper-airplane/audio/page-${pageNum}-en.mp3`);
...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('/paper-airplane/sw.js', { updateViaCache: 'none' });
}
