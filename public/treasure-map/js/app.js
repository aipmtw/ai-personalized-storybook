...
const pages = [
  ...
  },
  {
    ...
    emoji: '\uD83D\uDCDA\uD83D\uDDFA\uFE0F\uD83D\uDE2E',
    zh: '小寶在圖書館借了一本舊書，翻到最後一頁時，一張泛黃的手繪地圖從書裡滑了出來。地圖上畫著彎彎曲曲的路線，還寫著：「跟著線索走，你會找到最珍貴的寶藏。」',
    en: 'Xiao Bao borrowed an old book from the library. When flipping to the last page, a yellowed hand-drawn map slid out. The map showed a winding path with a note: "Follow the clues, and you will find the most precious treasure."'
  },
  {
    type: 'story',
    bg: 'page-bg-3',
    ...
    emoji: '\uD83C\uDFD8\uFE0F\uD83D\uDEE4\uFE0F\uD83E\uDDED',
    zh: '小寶仔細看地圖，發現上面畫的竟然是自己住的小鎮！第一個記號標在學校旁邊的巷子，第二個在河邊，第三個在火車站……小寶的心跳加速，決定馬上出發探險。',
    en: 'Xiao Bao studied the map carefully and realized it showed their own little town! The first mark was near the alley by the school, the second by the river, the third at the train station... Heart racing, Xiao Bao decided to set off on an adventure right away.'
  },
  {
    type: 'story',
    bg: 'page-bg-4',
    ...
    emoji: '\uD83C\uDF33\uD83D\uDD0D\u2709\uFE0F',
    zh: '第一條線索帶小寶來到鎮上最老的大榕樹。樹幹上有個小洞，小寶伸手進去，摸到一張紙條：「這棵樹已經在這裡守護小鎮一百年了。往河邊走，找那座最古老的橋。」',
    en: 'The first clue led Xiao Bao to the oldest banyan tree in town. There was a small hole in the trunk. Reaching inside, Xiao Bao found a note: "This tree has guarded the town for a hundred years. Head to the river and find the oldest bridge."'
  },
  {
    type: 'story',
    bg: 'page-bg-5',
    ...
    emoji: '\u26E9\uFE0F\uD83C\uDF0A\uD83D\uDCDC',
    zh: '小寶跑到河邊的老廟。廟門口的石獅子腳下，藏著另一張紙條：「這座廟是鎮上最早蓋的建築。人們在這裡祈求平安，也在這裡分享喜悅。下一站，去火車站看看牆上的畫。」',
    en: 'Xiao Bao ran to the old temple by the river. Under the stone lion\'s paw at the entrance, another note was hidden: "This temple is the oldest building in town. People come here to pray and share their joys. Next stop: look at the mural on the train station wall."'
  },
  {
    type: 'story',
    bg: 'page-bg-6',
    ...
    emoji: '\uD83D\uDE89\uD83D\uDDBC\uFE0F\uD83C\uDF1F',
    zh: '火車站的牆上有一幅大壁畫，畫著小鎮從前的樣子——稻田、老房子、和一群快樂的人。壁畫角落寫著一行小字：「想知道寶藏在哪裡嗎？找到畫這幅畫的人吧。」',
    en: 'On the train station wall was a large mural showing the town as it used to be — rice paddies, old houses, and happy people. In the corner of the mural, tiny words read: "Want to know where the treasure is? Find the person who painted this."'
  },
  {
    type: 'story',
    bg: 'page-bg-7',
    ...
    emoji: '\uD83D\uDC74\uD83C\uDFA8\uD83D\uDE0A',
    zh: '小寶問了車站的阿姨，找到了住在巷子裡的陳爺爺。陳爺爺看到地圖，笑了：「這是我五十年前畫的！那時候我跟你一樣大，也喜歡到處探險。」',
    en: 'Xiao Bao asked the lady at the station and found Grandpa Chen, who lived in a nearby alley. When Grandpa Chen saw the map, he smiled: "I drew this fifty years ago! Back then, I was your age and loved exploring everywhere too."'
  },
  {
    type: 'story',
    bg: 'page-bg-8',
    ...
    emoji: '\uD83C\uDFE1\u2764\uFE0F\uD83D\uDCA1',
    zh: '陳爺爺摸摸小寶的頭說：「你知道真正的寶藏是什麼嗎？不是金銀珠寶，而是認識你住的地方——每一棵老樹、每一座橋、每一個故事，都是這個小鎮的寶藏。」',
    en: 'Grandpa Chen patted Xiao Bao\'s head and said: "Do you know what the real treasure is? It\'s not gold or jewels — it\'s knowing your hometown. Every old tree, every bridge, every story is a treasure of this little town."'
  },
  {
    type: 'story',
    bg: 'page-bg-9',
    ...
    emoji: '\u26F0\uFE0F\uD83C\uDF05\uD83D\uDE0D',
    zh: '陳爺爺帶小寶走到地圖上最後一個記號——鎮上的小山丘。站在山頂，他們可以看到整個小鎮：彎彎的河、綠綠的田、紅屋頂的房子，還有遠方的山。「好美啊！」小寶說。',
    en: 'Grandpa Chen took Xiao Bao to the last mark on the map — the hilltop overlooking the town. From the top, they could see the whole town: the winding river, green fields, red-roofed houses, and mountains in the distance. "It\'s so beautiful!" said Xiao Bao.'
  },
  {
    type: 'end',
    bg: 'page-bg-10',
    ...
    emoji: '\uD83D\uDDFA\uFE0F\u270D\uFE0F\uD83C\uDF1F',
    zh: '回到家後，小寶拿出畫筆，開始畫一張新的寶藏地圖。這次地圖上多了新的咖啡店、新的公園，還有小寶自己發現的秘密小路。「也許五十年後，會有另一個小朋友找到這張地圖呢！」',
    en: 'Back home, Xiao Bao picked up some colored pencils and started drawing a new treasure map. This time it included the new cafe, the new park, and secret paths Xiao Bao had discovered. "Maybe in fifty years, another kid will find this map!"'
  }
];
...
function lineLoginFromGate() {
  ...
  const returnUrl = encodeURIComponent(window.location.origin + '/treasure-map/book.html');
...
function updateUI() {
  ...
  const colors = ['#d4a574','#faf3e0','#e8f5e9','#e3f2fd','#fff8e1','#fbe9e7','#f3e5f5','#e0f2f1','#fff3e0','#ede7f6'];
  document.querySelector('meta[name="theme-color"]').content = colors[currentPage] || '#d4a574';
}
...
function toggleAudio() {
  ...
  if (langMode === 'both' || langMode === 'zh') {
    files.push(`/treasure-map/audio/page-${pageNum}-zh.mp3`);
  }
  if (langMode === 'both' || langMode === 'en') {
    files.push(`/treasure-map/audio/page-${pageNum}-en.mp3`);
  }
  ...
  for (let i = 0; i < totalDurations.length; i++) {
    ...
    if (cumulative + d >= target) {
      ...
      if (i === currentFileIndex && currentAudio) {
        ...
        const pageNum = currentPage + 1;
        const files = [];
        if (langMode === 'both' || langMode === 'zh') files.push(`/treasure-map/audio/page-${pageNum}-zh.mp3`);
        if (langMode === 'both' || langMode === 'en') files.push(`/treasure-map/audio/page-${pageNum}-en.mp3`);
...
if ('serviceWorker' in navigator) {
  navigator.serviceWorker.register('/treasure-map/sw.js', { updateViaCache: 'none' });
}
