...
const pages = [
  ...
  },
  {
    ...
    emoji: '📱👧✨',
    zh: '小真是一個十一歲的女孩，她在平板上發現了一個新的學習 App。「AI 學習夥伴——讓你的學習更有效率！」她好奇地下載了它，螢幕上出現了一個閃爍的藍色小助手。',
    en: 'Xiao Zhen is an eleven-year-old girl who discovered a new learning app on her tablet. "AI Study Partner — make your learning more efficient!" Curious, she downloaded it, and a blinking blue assistant appeared on the screen.'
  },
  {
    type: 'story',
    bg: 'page-bg-3',
    ...
    emoji: '🤖📝💯',
    zh: '「嗨，小真！把你的功課交給我吧！」AI 夥伴說。小真試著把數學作業輸入進去，幾秒鐘後，所有答案都完美地呈現出來。「哇，太厲害了！」她興奮地把答案抄了下來。',
    en: '"Hi, Xiao Zhen! Leave your homework to me!" the AI partner said. She typed in her math homework, and within seconds, all the answers appeared perfectly. "Wow, that\'s amazing!" She excitedly copied the answers down.'
  },
  {
    type: 'story',
    bg: 'page-bg-4',
    ...
    emoji: '🏆💯💯',
    zh: '接下來的幾週，小真每一科都拿了滿分。作文、自然、社會——AI 夥伴總是能給出完美的答案。同學們都用羨慕的眼光看著她，她覺得自己成了班上最聰明的人。',
    en: 'Over the next few weeks, Xiao Zhen got perfect scores in every subject. Essays, science, social studies — the AI partner always gave perfect answers. Her classmates looked at her with envy, and she felt like the smartest person in class.'
  },
  {
    type: 'story',
    bg: 'page-bg-5',
    ...
    emoji: '👩‍🏫❓😰',
    zh: '有一天，老師在課堂上請小真上台解釋她的自然報告。「小真，你寫得很好，請跟大家說明一下光合作用的過程。」小真站在台上，腦袋一片空白——她根本不懂那些內容。',
    en: 'One day, the teacher asked Xiao Zhen to explain her science report in front of the class. "Xiao Zhen, your report is excellent. Please explain the process of photosynthesis to everyone." Standing at the front, her mind went completely blank — she didn\'t understand any of it.'
  },
  {
    type: 'story',
    bg: 'page-bg-6',
    ...
    emoji: '😔💭🤝',
    zh: '放學後，小真打開平板，看著 AI 夥伴的藍色光芒，深深嘆了一口氣。「你確實幫了我很多，但是⋯⋯我什麼都沒學到。我需要的是真正學會，而不是只拿到答案。」',
    en: 'After school, Xiao Zhen opened her tablet and stared at the AI partner\'s blue glow, letting out a deep sigh. "You\'ve helped me a lot, but... I haven\'t learned anything. I need to actually learn, not just get answers."'
  },
  {
    type: 'story',
    bg: 'page-bg-7',
    ...
    emoji: '🤖💡❓',
    zh: 'AI 夥伴閃了閃，說：「了解了！我可以切換到教學模式。從現在開始，我不會直接給你答案，而是問你問題，引導你自己找到答案。準備好了嗎？」小真點了點頭。',
    en: 'The AI partner flickered and said, "Understood! I can switch to teaching mode. From now on, I won\'t give you answers directly. Instead, I\'ll ask you questions and guide you to find the answers yourself. Ready?" Xiao Zhen nodded.'
  },
  {
    type: 'story',
    bg: 'page-bg-8',
    ...
    emoji: '📚🧠💪',
    zh: '學習變得比以前辛苦多了。AI 夥伴會問：「你覺得為什麼植物需要陽光？」小真必須自己思考、查資料、反覆嘗試。有時候很挫折，但每次弄懂一個概念，她都感到一陣真實的成就感。',
    en: 'Studying became much harder than before. The AI partner would ask, "Why do you think plants need sunlight?" Xiao Zhen had to think on her own, look things up, and try again and again. Sometimes it was frustrating, but every time she understood a concept, she felt a genuine sense of achievement.'
  },
  {
    type: 'story',
    bg: 'page-bg-9',
    ...
    emoji: '📊✅🗣️',
    zh: '下一次考試，小真的成績稍微低了一些——九十二分。但當老師再次請她上台解說時，她清楚地說出了每一個答案背後的原因。同學們報以真誠的掌聲，老師也露出了滿意的微笑。',
    en: 'On the next test, Xiao Zhen\'s score was slightly lower — ninety-two points. But when the teacher asked her to explain again, she clearly articulated the reasoning behind every answer. Her classmates gave her sincere applause, and the teacher smiled with satisfaction.'
  },
  {
    type: 'end',
    bg: 'page-bg-10',
    ...
    emoji: '📓🤝🌱',
    zh: '那天晚上，小真在日記本上寫下：「一個真正的夥伴，是幫助你成長，而不是只幫你贏。」她看了一眼平板上的 AI 夥伴，藍光溫柔地閃爍著，像是在說：「我會一直在這裡，陪你一起學。」',
    en: 'That night, Xiao Zhen wrote in her diary: "A true partner helps you grow, not just win." She glanced at the AI partner on her tablet. Its blue light flickered gently, as if saying, "I\'ll always be here, learning alongside you."'
  }
];
...
function updateThemeColor() {
  const colors = ['#0d1a2e','#0d1a2e','#1e88e5','#0d1a2e','#263238','#0d47a1','#1e88e5','#0d1a2e','#1565c0','#0d1a2e'];
