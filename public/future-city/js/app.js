...
const pages = [
  ...
  },
  {
    ...
    emoji: '🏆🎨👧',
    zh: '2060 年，十歲的小澄贏得了全國城市設計大賽。評審們被她的作品震撼了——那是一座活生生的城市，像一片會呼吸的森林。',
    en: 'In the year 2060, ten-year-old Xiao Cheng won the national city design competition. The judges were stunned by her work — a living city that breathed like a forest.'
  },
  {
    type: 'story',
    bg: 'page-bg-3',
    ...
    emoji: '🌳🏢🌿',
    zh: '她的設計是一座建築物像樹木一樣生長的城市。每棟大樓都有彎曲的牆壁和伸展的陽台，像樹枝一樣向天空延伸，隨著季節變換顏色。',
    en: 'Her design was a city where buildings grew like trees. Every tower had curving walls and stretching balconies, reaching toward the sky like branches, changing color with the seasons.'
  },
  {
    type: 'story',
    bg: 'page-bg-4',
    ...
    emoji: '☀️🍃💡',
    zh: '每一面牆壁、每一片屋頂都覆蓋著太陽能葉片。這些人造樹葉在白天吸收陽光，到了夜晚就發出柔和的綠光，讓整座城市像一片發光的森林。',
    en: 'Every wall and rooftop was covered with solar leaves. These artificial leaves absorbed sunlight during the day and glowed soft green at night, making the whole city shine like a luminous forest.'
  },
  {
    type: 'story',
    bg: 'page-bg-5',
    ...
    emoji: '🌊🐟🛤️',
    zh: '街道上沒有汽車，取而代之的是清澈的河流穿過城市的每一個角落。人們可以沿著河岸散步，魚兒在腳邊的水中悠游。',
    en: 'There were no cars on the streets. Instead, crystal-clear rivers flowed through every corner of the city. People strolled along the riverbanks while fish swam leisurely in the water at their feet.'
  },
  {
    type: 'story',
    bg: 'page-bg-6',
    ...
    emoji: '🤖📦🛸',
    zh: '所有的物資都由無人機運送。安靜的小型飛行器在建築物之間穿梭，把包裹送到每一戶人家的窗台上，不需要任何道路。',
    en: 'Everything was delivered by drones. Quiet little aircraft zipped between buildings, dropping packages on every family\'s windowsill — no roads needed at all.'
  },
  {
    type: 'story',
    bg: 'page-bg-7',
    ...
    emoji: '👩‍💼🎤📊',
    zh: '小澄站在市長面前，自信地展示她的設計。「這座城市不只是環保，」她說，「它會跟大自然一起呼吸。」市長認真地聽著，眼中充滿了驚嘆。',
    en: '"This city doesn\'t just protect the environment," Xiao Cheng said confidently, presenting her design to the mayor. "It breathes together with nature." The mayor listened intently, eyes wide with wonder.'
  },
  {
    type: 'story',
    bg: 'page-bg-8',
    ...
    emoji: '🤔🎢❓',
    zh: '但市長提出了一個問題：「孩子們要在哪裡玩耍呢？」小澄愣了一下。她的設計裡有河流、有森林，卻忘了最重要的事——人們需要玩樂的空間。',
    en: 'But the mayor raised a question: "Where will children play?" Xiao Cheng paused. Her design had rivers and forests, but she had forgotten the most important thing — people need space to play.'
  },
  {
    type: 'story',
    bg: 'page-bg-9',
    ...
    emoji: '🌳🎡🏗️',
    zh: '小澄拿起畫筆，在每一棟建築物的屋頂畫上了公園。滑梯、鞦韆、花園、籃球場——每一個屋頂都變成了孩子們的天堂。市長拍手說：「就這麼辦，我們來蓋它！」',
    en: 'Xiao Cheng picked up her pen and drew parks on every rooftop. Slides, swings, gardens, basketball courts — every rooftop became a paradise for children. The mayor clapped and said, "Let\'s build it!"'
  },
  {
    type: 'end',
    bg: 'page-bg-10',
    ...
    emoji: '🌆🌿✨',
    zh: '十年後，小澄走在她親手設計的城市裡。陽光穿過太陽能樹葉，河水在腳邊流淌，孩子們在屋頂公園裡歡笑奔跑。這座城市活了起來，綠意盎然，就像她夢想中的模樣。',
    en: 'Ten years later, Xiao Cheng walked through the city she had designed. Sunlight filtered through solar leaves, rivers flowed at her feet, and children laughed and ran in rooftop parks. The city was alive and green — exactly as she had dreamed.'
  }
];
...
function updateThemeColor() {
  const colors = ['#0a1a0f','#0d1f14','#0a1a0f','#0f2318','#0a1a12','#0d1f17','#0a1510','#0f2518','#0a1a0f','#0d2818'];
