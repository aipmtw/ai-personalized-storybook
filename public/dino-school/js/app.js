...
const pages = [
  ...
  },
  {
    ...
    emoji: '🦕😰🎒',
    zh: '今天是小恐龍第一天上學。他背著新書包，站在家門口，心裡好緊張。「我不認識任何人，怎麼辦？」',
    en: 'Today is Little Dino\'s first day of school. He stood at the door with his new backpack, feeling very nervous. "I don\'t know anyone. What should I do?"'
  },
  {
    type: 'story',
    bg: 'page-bg-3',
    ...
    emoji: '👩\u200D🏫🦕🌿',
    zh: '走進教室，一位溫柔的腕龍老師微笑著說：「歡迎你，小恐龍！我是長頸老師，你的位子在這裡喔。」',
    en: 'Walking into the classroom, a gentle Brachiosaurus teacher smiled and said: "Welcome, Little Dino! I\'m Teacher Long Neck. Your seat is right here."'
  },
  {
    type: 'story',
    bg: 'page-bg-4',
    ...
    emoji: '🔢🎵🦕',
    zh: '長頸老師教大家數數：「一、二、三！」然後大家一起唱歌。小恐龍跟著唱，覺得好好玩！',
    en: 'Teacher Long Neck taught everyone to count: "One, two, three!" Then everyone sang together. Little Dino sang along and thought it was so much fun!'
  },
  {
    type: 'story',
    bg: 'page-bg-5',
    ...
    emoji: '🍱🦕🐊',
    zh: '午餐時間到了！小恐龍坐在一隻小鱷魚旁邊。「你的便當看起來好好吃！我叫小鱷，我們一起吃吧！」',
    en: 'Lunchtime arrived! Little Dino sat next to a little crocodile. "Your lunch looks so yummy! I\'m Croco. Let\'s eat together!"'
  },
  {
    type: 'story',
    bg: 'page-bg-6',
    ...
    emoji: '⚽🌳🦕🐊',
    zh: '下課了，小恐龍和小鱷一起到操場玩。他們踢球、跑步、還爬到大樹下乘涼。',
    en: 'Recess time! Little Dino and Croco went to the playground together. They kicked a ball, ran around, and rested under a big tree.'
  },
  {
    type: 'story',
    bg: 'page-bg-7',
    ...
    emoji: '⛈️😰🦕',
    zh: '突然，天空打了一聲好大的雷！「轟隆隆！」小恐龍嚇了一跳，眼睛紅紅的，快要哭了。',
    en: 'Suddenly, there was a loud thunderclap! "BOOM!" Little Dino was so scared, his eyes turned red, and he almost cried.'
  },
  {
    type: 'story',
    bg: 'page-bg-8',
    ...
    emoji: '🤗💚🦕🐊',
    zh: '小鱷趕快跑過來，緊緊牽著小恐龍的手。「別怕！有我在！我們是好朋友，雷打不到我們的。」',
    en: 'Croco quickly ran over and held Little Dino\'s hand tightly. "Don\'t be afraid! I\'m here! We\'re best friends. The thunder can\'t get us."'
  },
  {
    type: 'story',
    bg: 'page-bg-9',
    ...
    emoji: '🌈😊🦕🐊',
    zh: '雨停了，天空出現了一道美麗的彩虹。小恐龍笑了：「有你真好！你是我最好的朋友！」',
    en: 'The rain stopped and a beautiful rainbow appeared in the sky. Little Dino smiled: "I\'m so glad I have you! You are my best friend!"'
  },
  {
    type: 'end',
    bg: 'page-bg-10',
    ...
    emoji: '🌟🦕🐊🎒',
    zh: '放學了，小恐龍開心地跑回家。「媽媽！我交到好朋友了！我好喜歡上學！明天我還要去！」',
    en: 'School was over. Little Dino ran home happily. "Mama! I made a best friend! I love school! I can\'t wait to go back tomorrow!"'
  }
];
