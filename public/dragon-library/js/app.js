...
const pages = [
  ...
  },
  {
    ...
    emoji: '🏔️🐉🌙',
    zh: '在遙遠的東方山脈深處，住著一條古老的金龍，名叫耀光。他與其他龍不同——他不收藏金幣和寶石，而是收藏書籍。幾千年來，他建造了世界上最大的圖書館。',
    en: 'Deep in the mountains of the Far East lived an ancient golden dragon named Yaoguang. Unlike other dragons, he didn\'t hoard gold or jewels — he collected books. Over thousands of years, he had built the greatest library in the world.'
  },
  {
    type: 'story',
    bg: 'page-bg-3',
    ...
    emoji: '👧🏻🎒🌲',
    zh: '有一天，一個名叫小葉的女孩在森林裡迷了路。她發現了一個巨大的山洞入口，門上刻著金色的龍紋。好奇心驅使她推開了沉重的石門。',
    en: 'One day, a girl named Xiaoye got lost in the forest. She discovered the entrance to an enormous cave, its door carved with golden dragon patterns. Curiosity drove her to push open the heavy stone door.'
  },
  {
    type: 'story',
    bg: 'page-bg-4',
    ...
    emoji: '📖✨🏛️',
    zh: '門後是一片令人屏息的景象——無數的書架從地面延伸到看不見的天花板，每一本書都散發著微微的光芒。有的書在空中緩緩飄浮，有的書頁自己在翻動，訴說著古老的故事。',
    en: 'Behind the door lay a breathtaking sight — countless bookshelves stretched from the floor to an invisible ceiling, each book glowing with a gentle light. Some books floated gently in the air, while others turned their own pages, telling ancient stories.'
  },
  {
    type: 'story',
    bg: 'page-bg-5',
    ...
    emoji: '🐉👧🏻🔥',
    zh: '「歡迎，小讀者。」一個低沉而溫暖的聲音響起。耀光從書架後方探出金色的頭顱，他的眼睛像兩顆琥珀寶石。「很久沒有人類來訪了。你想讀什麼書呢？」',
    en: '"Welcome, young reader." A deep, warm voice echoed. Yaoguang\'s golden head appeared from behind a bookshelf, his eyes like two amber gemstones. "It\'s been ages since a human visited. What would you like to read?"'
  },
  {
    type: 'story',
    bg: 'page-bg-6',
    ...
    emoji: '🌊🏔️🌸',
    zh: '耀光帶小葉飛上最高的書架。他打開一本書，書頁綻放出光芒，周圍的空氣化為一片海洋的場景。「在我的圖書館裡，每本書都是一個可以走進去的世界。」小葉驚嘆不已。',
    en: 'Yaoguang carried Xiaoye up to the highest shelf. He opened a book, and its pages burst with light, transforming the air around them into an ocean scene. "In my library, every book is a world you can step into." Xiaoye gasped in wonder.'
  },
  {
    type: 'story',
    bg: 'page-bg-7',
    ...
    emoji: '⚔️🌑😈',
    zh: '突然，圖書館深處傳來轟隆隆的聲響。一團黑霧正在吞噬書架上的書籍！耀光的表情變得嚴肅：「那是『遺忘之霧』——當人們不再閱讀，知識就會慢慢消失。」',
    en: 'Suddenly, a rumbling sound came from deep within the library. A dark mist was devouring the books on the shelves! Yaoguang\'s expression turned serious: "That is the Mist of Forgetting — when people stop reading, knowledge slowly fades away."'
  },
  {
    type: 'story',
    bg: 'page-bg-8',
    ...
    emoji: '📖💛🔥',
    zh: '小葉勇敢地拿起一本發光的書，大聲朗讀起來。每一個字都化為金色的光芒，驅散了黑霧。耀光也張開巨大的翅膀，用火焰書寫出古老的詩篇，光明再次充滿了圖書館。',
    en: 'Xiaoye bravely picked up a glowing book and began reading aloud. Each word transformed into golden light, driving away the dark mist. Yaoguang spread his mighty wings and wrote ancient verses in flame. Light filled the library once more.'
  },
  {
    type: 'story',
    bg: 'page-bg-9',
    ...
    emoji: '🌅🐉👧🏻',
    zh: '「謝謝你，小葉。」耀光微笑著說。「知識需要被分享才能永存。你願意成為我的圖書管理員嗎？把這些故事帶給更多的人。」小葉用力地點了點頭。',
    en: '"Thank you, Xiaoye," Yaoguang said with a smile. "Knowledge must be shared to last forever. Would you become my librarian? Bring these stories to more people." Xiaoye nodded eagerly.'
  },
  {
    type: 'end',
    bg: 'page-bg-10',
    ...
    emoji: '📚🐉🌟',
    zh: '從那天起，小葉每天都來到龍的圖書館，把書中的故事講給村裡的孩子們聽。而耀光守護著這些珍貴的知識，等待著下一個推開石門的小讀者…',
    en: 'From that day on, Xiaoye visited the Dragon\'s Library every day, sharing the stories with the children of her village. And Yaoguang continued guarding this precious knowledge, waiting for the next young reader to push open the stone door...'
  }
];
...
function updateThemeColor() {
  const colors = ['#c62828','#1a0a0a','#1a0a0a','#0d0d0d','#1a237e','#004d40','#311b92','#bf360c','#1a0a0a','#c62828'];
