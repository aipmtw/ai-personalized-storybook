...
const pages = [
  ...
  },
  {
    ...
    emoji: '🏡🌿🚪',
    zh: '露露住在一棟有大院子的房子裡。有一天，她在院子角落發現了一扇小小的門。',
    en: 'Lulu lives in a house with a big yard. One day, she found a tiny door in the corner of the yard.'
  },
  {
    type: 'story',
    bg: 'page-bg-3',
    ...
    emoji: '🚪🌺✨',
    zh: '露露打開小門，哇！裡面是一座好美好美的花園。到處都是五顏六色的花朵。',
    en: 'Lulu opened the little door. Wow! Inside was a beautiful garden full of colorful flowers.'
  },
  {
    type: 'story',
    bg: 'page-bg-4',
    ...
    emoji: '🌷🎵🌹',
    zh: '花園裡的花朵會唱歌！玫瑰唱高音，鬱金香唱低音，好好聽喔！',
    en: 'The flowers in the garden could sing! The roses sang high notes, and the tulips sang low notes. How lovely!'
  },
  {
    type: 'story',
    bg: 'page-bg-5',
    ...
    emoji: '🦋🌼💛',
    zh: '一隻金色的蝴蝶飛過來，停在露露的手上。「歡迎來到秘密花園！」蝴蝶說。',
    en: 'A golden butterfly flew over and landed on Lulu\'s hand. "Welcome to the secret garden!" said the butterfly.'
  },
  {
    type: 'story',
    bg: 'page-bg-6',
    ...
    emoji: '🌳👴🍃',
    zh: '花園中間有一棵好大的老樹。老樹爺爺笑著說：「照顧花園，花園也會照顧你。」',
    en: 'In the middle of the garden stood a big old tree. Grandpa Tree smiled and said, "Take care of the garden, and it will take care of you."'
  },
  {
    type: 'story',
    bg: 'page-bg-7',
    ...
    emoji: '🌻🐝💧',
    zh: '露露幫向日葵澆水，幫小蜜蜂找花蜜。她好喜歡照顧這座花園！',
    en: 'Lulu watered the sunflowers and helped the bees find nectar. She loved taking care of the garden!'
  },
  {
    type: 'story',
    bg: 'page-bg-8',
    ...
    emoji: '🌅🌸💕',
    zh: '太陽快下山了，花朵們輕輕搖擺說再見。露露說：「我明天還會再來！」',
    en: 'The sun was setting, and the flowers gently swayed goodbye. Lulu said, "I will come back tomorrow!"'
  },
  {
    type: 'story',
    bg: 'page-bg-9',
    ...
    emoji: '🌙🌷😊',
    zh: '露露帶著微笑回家了。她知道，只要用心愛護大自然，世界就會充滿美麗。',
    en: 'Lulu went home with a smile. She knew that if we care for nature, the world will be full of beauty.'
  },
  {
    type: 'end',
    bg: 'page-bg-10',
    ...
    emoji: '📓🌸🌍',
    zh: '從那天起，露露每天都去秘密花園，和花朵蝴蝶一起唱歌跳舞。',
    en: 'From that day on, Lulu visited the secret garden every day, singing and dancing with the flowers and butterflies.'
  }
];
...
function updateUI() {
  ...
  const colors = ['#e8a0bf','#a8d8a0','#f4a0c0','#b0d890','#f0c060','#c0a8e0','#90c8a0','#f8c8a0','#e0b0d0','#a0c8b0'];
