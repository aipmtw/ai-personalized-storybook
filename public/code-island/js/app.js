...
const pages = [
  ...
  },
  {
    ...
    emoji: '🏝️🖥️✨',
    zh: '在遙遠的數位海洋中，有一座神祕的「程式島」。傳說島上藏著一個能實現任何願望的「終極程式碼」，但只有懂得程式思維的人才能找到它。',
    en: 'In a distant digital ocean, there lies a mysterious "Code Island." Legend says the island holds an "Ultimate Code" that can make any wish come true, but only those who understand computational thinking can find it.'
  },
  {
    type: 'story',
    bg: 'page-bg-3',
    ...
    emoji: '👧💡🤖',
    zh: '小優是一個熱愛解謎的女孩。有一天，她的平板電腦突然彈出一條訊息：「歡迎來到程式島！我是 Byte，你的 AI 導航夥伴。準備好接受挑戰了嗎？」',
    en: "Xiao You is a girl who loves solving puzzles. One day, her tablet suddenly popped up a message: \"Welcome to Code Island! I'm Byte, your AI navigation partner. Are you ready for the challenge?\""
  },
  {
    type: 'story',
    bg: 'page-bg-4',
    ...
    emoji: '🌿🔢🚪',
    zh: '小優被傳送到島上的第一關——「序列森林」。樹木上刻著數字和符號，她必須找出正確的排列順序才能打開通往下一關的大門。Byte 提示：「試試找出規律吧！」',
    en: 'Xiao You was teleported to the first level \u2014 "Sequence Forest." Numbers and symbols were carved on the trees, and she had to find the correct order to open the gate to the next level. Byte hinted, "Try to find the pattern!"'
  },
  {
    type: 'story',
    bg: 'page-bg-5',
    ...
    emoji: '🔄🌀🎯',
    zh: '第二關是「迴圈迷宮」。小優發現迷宮的牆壁會不斷重複移動。她靈機一動：「如果牆壁的移動是一個迴圈，我只要計算它的週期，就能找到出口！」',
    en: 'The second level was "Loop Labyrinth." Xiao You noticed the maze walls kept moving in repeating patterns. She had a flash of insight: "If the walls move in a loop, I just need to calculate the cycle to find the exit!"'
  },
  {
    type: 'story',
    bg: 'page-bg-6',
    ...
    emoji: '🐛🔍🔧',
    zh: '第三關是「除錯沼澤」。沼澤裡到處是看起來正確、實際上有錯誤的程式碼石板。小優仔細地一行一行檢查，終於找出隱藏的 bug，沼澤的水漸漸退去，露出了前方的路。',
    en: 'The third level was "Debug Swamp." The swamp was full of code tablets that looked correct but had hidden errors. Xiao You carefully checked line by line, finally found the hidden bug, and the swamp water gradually receded, revealing the path ahead.'
  },
  {
    type: 'story',
    bg: 'page-bg-7',
    ...
    emoji: '🏔️⚡🤝',
    zh: '第四關是「條件山峰」。山路上有許多岔路，每個岔路口都有一個「如果...就...」的判斷題。Byte 說：「這就是條件判斷！選擇正確的條件，就能到達山頂。」小優和 Byte 一起討論每個選擇。',
    en: 'The fourth level was "Conditional Peak." The mountain path had many forks, each with an "if...then..." decision question. Byte said, "This is conditional logic! Choose the right conditions to reach the summit." Xiao You and Byte discussed each choice together.'
  },
  {
    type: 'story',
    bg: 'page-bg-8',
    ...
    emoji: '🏰🧩💎',
    zh: '終於，小優來到了島的中心——「演算法城堡」。城堡的大門需要用之前學到的所有技能：排序、迴圈、除錯和條件判斷，組合成一段完整的程式碼才能開啟。小優深吸一口氣，開始編寫。',
    en: "Finally, Xiao You arrived at the island's center \u2014 \"Algorithm Castle.\" The castle gate required all the skills she had learned: sorting, loops, debugging, and conditionals, combined into a complete program to open it. Xiao You took a deep breath and began coding."
  },
  {
    type: 'story',
    bg: 'page-bg-9',
    ...
    emoji: '🌟📜🎉',
    zh: '城堡大門緩緩開啟，裡面浮現出終極程式碼。但它不是一個魔法咒語——而是一行簡單的文字：「真正的力量，是用程式解決問題、幫助他人。」小優笑了，她終於明白了程式的真正意義。',
    en: "The castle gate slowly opened, revealing the Ultimate Code. But it wasn't a magic spell \u2014 it was a simple message: \"True power is using code to solve problems and help others.\" Xiao You smiled. She finally understood the true meaning of programming."
  },
  {
    type: 'end',
    bg: 'page-bg-10',
    ...
    emoji: '💻🌍🚀',
    zh: '回到現實世界後，小優開始用程式幫助身邊的人：幫媽媽做記帳程式、幫同學設計互動遊戲。而 Byte 始終陪在她身邊，等待下一次冒險的來臨……',
    en: 'Back in the real world, Xiao You began using code to help people around her: building a budgeting app for her mom, designing interactive games for classmates. And Byte stayed by her side, waiting for the next adventure to come...'
  }
];
...
function updateThemeColor() {
  const colors = ['#00897b','#0a1a18','#00695c','#1a3a2a','#004d40','#0d2818','#263238','#b71c1c','#0a1a18','#1b5e20'];
