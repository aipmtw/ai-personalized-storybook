...
const pages = [
  ...
  },
  {
    ...
    emoji: '🐠🪸🌊',
    zh: '小魚悠悠住在美麗的珊瑚礁裡。每天早上，她都會在五顏六色的珊瑚之間游來游去，跟海葵說早安。',
    en: 'Little fish Youyou lives in a beautiful coral reef. Every morning, she swims among the colorful corals and says good morning to the sea anemones.'
  },
  {
    type: 'story',
    bg: 'page-bg-3',
    ...
    emoji: '🐢😢🐠',
    zh: '有一天，悠悠遇到了一隻迷路的小海龜。「你怎麼了？」悠悠問。小海龜說：「我找不到回家的路了。」',
    en: 'One day, Youyou met a lost baby sea turtle. "What\'s wrong?" asked Youyou. The little turtle said, "I can\'t find my way home."'
  },
  {
    type: 'story',
    bg: 'page-bg-4',
    ...
    emoji: '🐠🐢🌿',
    zh: '「別擔心，我陪你一起找！」悠悠說。她們一起游過了長長的海藻森林，陽光從水面灑下來，好漂亮。',
    en: '"Don\'t worry, I\'ll help you find it!" said Youyou. They swam together through a tall kelp forest, with sunlight streaming down from the surface.'
  },
  {
    type: 'story',
    bg: 'page-bg-5',
    ...
    emoji: '🐙😊🫧',
    zh: '在海藻森林裡，她們遇到了一隻害羞的章魚。「嗨！你要不要跟我們一起冒險？」章魚開心地點點頭，變成了粉紅色。',
    en: 'In the kelp forest, they met a shy octopus. "Hi! Do you want to join our adventure?" The octopus nodded happily and turned pink.'
  },
  {
    type: 'story',
    bg: 'page-bg-6',
    ...
    emoji: '🐬💨🎉',
    zh: '一隻活潑的海豚跳出水面，濺起好大的水花。「我也要加入！」海豚在她們身邊快樂地翻轉。',
    en: 'A playful dolphin leaped out of the water with a big splash. "I want to join too!" The dolphin spun happily around them.'
  },
  {
    type: 'story',
    bg: 'page-bg-7',
    ...
    emoji: '🏴‍☠️📦✨',
    zh: '大家一起發現了一個沉在海底的寶箱！打開一看，裡面裝滿了閃閃發亮的貝殼和彩色珍珠。',
    en: 'Together, they discovered a sunken treasure chest on the ocean floor! Inside, it was filled with shiny shells and colorful pearls.'
  },
  {
    type: 'story',
    bg: 'page-bg-8',
    ...
    emoji: '🐋👶🥺',
    zh: '這時候，她們聽到了哭聲。一隻小鯨魚在哭，因為找不到媽媽。大家決定一起幫小鯨魚找媽媽。',
    en: 'Just then, they heard crying. A baby whale was sobbing because it couldn\'t find its mother. Everyone decided to help the baby whale.'
  },
  {
    type: 'story',
    bg: 'page-bg-9',
    ...
    emoji: '🐢🏠💙',
    zh: '海豚游得最快，很快就找到了鯨魚媽媽。接著，小海龜也認出了前方的珊瑚礁——那是她的家！',
    en: 'The dolphin swam the fastest and quickly found the mother whale. Then, the little turtle recognized the coral reef ahead — it was her home!'
  },
  {
    type: 'end',
    bg: 'page-bg-10',
    ...
    emoji: '🐠🐢🐙🐬🎊',
    zh: '大家開心地慶祝，悠悠笑著說：「原來大海裡到處都是好朋友！」從此以後，她們常常一起在海裡冒險。',
    en: 'Everyone celebrated joyfully. Youyou smiled and said, "The ocean is full of friends!" From then on, they often went on adventures together.'
  }
];
